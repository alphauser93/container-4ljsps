...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-4ljsps.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-4ljsps.containers.anotherwebservice.com/
...
```
git clone git@github.com:alphauser93/container-4ljsps.git
cd container-4ljsps
```
...
```
docker attach container-4ljsps
```
